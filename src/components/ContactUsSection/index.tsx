          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 flex flex-col md:flex-row justify-between">
              <button
                ...
                className="w-44 h-14 bg-black rounded text-white text-xs font-bold font-['DM_Sans'] uppercase leading-tight tracking-wide hover:bg-neutral-800 transition-colors"
              >
                Send Message
              </button>
